...
namespace ChickenScratch
{
    public class AccoladesTest : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            redRow.birdHeadImage.sprite = ColourManager.Instance.GetBird(ColourManager.BirdName.red).faceSprite;
            redRow.playerNameText.text = "Chicken";
            redRow.playerNameText.color = ColourManager.Instance.GetBird(ColourManager.BirdName.red).colour;
            ...
            blueRow.birdHeadImage.sprite = ColourManager.Instance.GetBird(ColourManager.BirdName.blue).faceSprite;
            blueRow.playerNameText.text = "Parrot";
            blueRow.playerNameText.color = ColourManager.Instance.GetBird(ColourManager.BirdName.blue).colour;
            ...
            greenRow.birdHeadImage.sprite = ColourManager.Instance.GetBird(ColourManager.BirdName.green).faceSprite;
            greenRow.playerNameText.text = "Duck";
            greenRow.playerNameText.color = ColourManager.Instance.GetBird(ColourManager.BirdName.green).colour;
            ...
            purpleRow.birdHeadImage.sprite = ColourManager.Instance.GetBird(ColourManager.BirdName.purple).faceSprite;
            purpleRow.playerNameText.text = "Penguin";
            purpleRow.playerNameText.color = ColourManager.Instance.GetBird(ColourManager.BirdName.purple).colour;
            ...
            grayRow.birdHeadImage.sprite = ColourManager.Instance.GetBird(ColourManager.BirdName.grey).faceSprite;
            grayRow.playerNameText.text = "Dove";
            grayRow.playerNameText.color = ColourManager.Instance.GetBird(ColourManager.BirdName.grey).colour;
            ...
            orangeRow.birdHeadImage.sprite = ColourManager.Instance.GetBird(ColourManager.BirdName.orange).faceSprite;
            orangeRow.playerNameText.text = "Toucan";
            orangeRow.playerNameText.color = ColourManager.Instance.GetBird(ColourManager.BirdName.orange).colour;
            ...
            blackRow.birdHeadImage.sprite = ColourManager.Instance.GetBird(ColourManager.BirdName.black).faceSprite;
            blackRow.playerNameText.text = "Crow";
            blackRow.playerNameText.color = ColourManager.Instance.GetBird(ColourManager.BirdName.black).colour;
            ...
            maroonRow.birdHeadImage.sprite = ColourManager.Instance.GetBird(ColourManager.BirdName.brown).faceSprite;
            maroonRow.playerNameText.text = "Ostrich";
            maroonRow.playerNameText.color = ColourManager.Instance.GetBird(ColourManager.BirdName.brown).colour;
