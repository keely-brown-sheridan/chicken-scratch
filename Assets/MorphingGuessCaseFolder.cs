...
{
    public class MorphingGuessCaseFolder : CaseFolder
    {
        [SerializeField]
        TMPro.TMP_Text guessText, morphGuessText;
        ...
        [SerializeField]
        private DrawingsContainer guessingContainer, morphedContainer;
        ...
        public void Initialize(int round, int caseID, Dictionary<int, List<string>> inPossibleWords, DrawingData drawingData, DrawingData morphedDrawingData, List<TaskData.TaskModifier> taskModifiers, UnityAction inTimeCompleteAction)
        {
        ...
        public override void Hide()
        {
            ...
            morphedContainer.HidePreviousDrawings();
        ...
        public void SetGuess(string wordIndexCombo)
        {
            ...
            guessText.text = nounText;
            morphGuessText.text = prefixText + " " + nounText;
        }
